...
# NEWLY UPDATED -> Student(AbstractPerson) -> Inherit from AbstractPerson 
# and Payables 
class Student(AbstractPerson, Payables):    
    ...
    def calculate_payment(self):
        """Calculate payment for the student (course fee)"""
        return self.calculate_course_fee()